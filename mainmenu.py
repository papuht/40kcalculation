...
insert.add_command(label = "Insert melee weapons", command = openMeleeWeapon)
insert.add_command(label = "Insert ranged weapons", command = openRWInsert)
